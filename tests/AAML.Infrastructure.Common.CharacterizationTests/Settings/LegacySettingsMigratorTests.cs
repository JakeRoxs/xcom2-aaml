...
public sealed class LegacySettingsMigratorTests
{
    ...
    public async Task FilesystemBootstrap_MigratesOnceAndNeverModifiesLegacySource()
    {
        ...
        try
        {
            ...
            modern.Should().Contain("\"schemaVersion\": 11").And.Contain("\"theme\": \"Light\"").And.Contain("\"workshopStartupRefresh\": \"AllMods\"").And.Contain("\"textScale\": 1.00").And.Contain("\"iconScale\": 1.00");
